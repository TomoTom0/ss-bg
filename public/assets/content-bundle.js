(function(z){"use strict";function q(e){if(e.id)return`#${e.id}`;const n=e;if(n.name)return`input[name="${n.name}"]`;if(n.type){const o=e.closest("form");if(o){const a=Array.from(o.querySelectorAll(`input[type="${n.type}"]`)).indexOf(e);if(a>=0)return`form input[type="${n.type}"]:nth-of-type(${a+1})`}}const t=e.parentElement;if(t){const s=Array.from(t.children).indexOf(e);return`${t.tagName.toLowerCase()} > :nth-child(${s+1})`}return"input"}function A(e){const n=e.type.toLowerCase();if(n==="password")return"password";if(n==="email")return"email";if(n==="tel")return"tel";const t=e.name.toLowerCase(),o=["user","login","account","id","userid","username","loginid"],s=["email","mail"],a=["phone","tel","mobile"];if(o.some(l=>t.includes(l)))return"username";if(s.some(l=>t.includes(l)))return"email";if(a.some(l=>t.includes(l)))return"tel";const r=e.id.toLowerCase();if(o.some(l=>r.includes(l)))return"username";if(s.some(l=>r.includes(l)))return"email";if(a.some(l=>r.includes(l)))return"tel";const i=e.placeholder.toLowerCase();if(o.some(l=>i.includes(l)))return"username";if(s.some(l=>i.includes(l)))return"email";if(a.some(l=>i.includes(l)))return"tel";const u=e.autocomplete.toLowerCase();return u==="username"?"username":u==="email"?"email":u==="tel"?"tel":n==="text"||n===""?"text":"unknown"}function U(e){const n=Array.from(e.querySelectorAll("input")),t=[];for(const o of n){if(o.offsetParent===null||o.type==="hidden"||o.type==="submit"||o.type==="button")continue;const s=A(o),a=q(o);let r=50;o.type==="password"&&(r=100),o.type==="email"&&(r=90),o.name&&(r+=20),o.id&&(r+=10),t.push({element:o,type:s,confidence:Math.min(r,100),selector:a})}return t}function _(){const e=document.activeElement;return e&&e.tagName==="INPUT"?e:null}function R(e){const n=U(e),t=window.location.href;let o="",s="",a="",r="";const i=[];for(const c of n){const g=c.element.value;if(g)if(c.type==="password"&&!s)s=g,r=c.selector;else if(c.type==="username"&&!o)o=g,a=c.selector;else if(c.type==="email"&&!o)o=g,a=c.selector;else{const p=c.element.name||c.element.placeholder||`フィールド${i.length+1}`;i.push({name:p,value:g,selector:c.selector})}}return{title:new URL(t).hostname,urls:[t],username:o,password:s,usernameSelector:a,passwordSelector:r,additionalFields:i.length>0?i:void 0}}function j(){return Array.from(document.querySelectorAll("form"))}function G(e,n){if(n.length===0)return 0;let t;try{t=new URL(e)}catch{return 0}if(n.includes(e))return 2;for(const o of n)try{const s=new URL(o);if(t.hostname===s.hostname&&t.port===s.port)return 1}catch{continue}return 0}function X(e){const n=e.trim();if(!n)return"";try{const t=new URL(n);let o=t.hostname+t.pathname;return t.port&&!(t.protocol==="http:"&&t.port==="80"||t.protocol==="https:"&&t.port==="443")&&(o=t.hostname+":"+t.port+t.pathname),o.endsWith("/")&&(o=o.slice(0,-1)),o}catch{return n}}let b=null,d=null,f=null,v=null,S=null,F=[];const L="ss-bg-highlight-target";function Y(){V(),oe(),se(),K()}function V(){if(document.getElementById("ss-bg-highlight-styles"))return;const e=document.createElement("style");e.id="ss-bg-highlight-styles",e.textContent=`
  ...
  `,document.body.appendChild(t),F.push(t)}function te(e){k();const n=b?.closest("form")||document.querySelector("form");if(!n)return;const t=Array.from(n.querySelectorAll("input")),o=t.find(s=>s.type==="password"&&s.offsetParent!==null);if(o){C(o);const s=t.indexOf(o);for(let a=s-1;a>=0;a--){const r=t[a],i=A(r);if((i==="username"||i==="email"||i==="text")&&r.offsetParent!==null){C(r);break}}}}function k(){F.forEach(e=>{e.parentNode&&e.parentNode.removeChild(e)}),F=[],document.querySelectorAll(`.${L}`).forEach(e=>{e.classList.remove(L)})}function P(){f&&h()}function T(e){f=document.createElement("div"),f.id=e,f.style.cssText=`
    ...
    z-index: 2147483647;
    pointer-events: none;
  `,v=f.attachShadow({mode:"closed"})}function M(e,n){const t=document.createElement("style");t.textContent=e,v.appendChild(t),v.appendChild(n),document.body.appendChild(f),S=document.activeElement;const o='button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])',s=n.querySelector(o);s&&s.focus();const a=n.querySelectorAll(o),r=a[0],i=a[a.length-1],u=l=>{l.key==="Tab"&&(l.shiftKey?document.activeElement===r&&(l.preventDefault(),i.focus()):document.activeElement===i&&(l.preventDefault(),r.focus()))};n.addEventListener("keydown",u)}function $(e){P(),T("ss-bg-error-dialog-host");const n=document.createElement("div");n.className="ss-bg-error-dialog-content",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true");const t=document.createElement("div");t.className="ss-bg-error-title",t.id="ss-bg-error-dialog-title",t.textContent="エラー",n.setAttribute("aria-labelledby","ss-bg-error-dialog-title");const o=document.createElement("div");o.className="ss-bg-error-message",o.textContent=e;const s=document.createElement("button");s.className="ss-bg-error-close-btn",s.textContent="閉じる",s.onclick=h,n.appendChild(t),n.appendChild(o),n.appendChild(s),M(`
